...
/******/ 	return __webpack_require__(__webpack_require__.s = "K/ZM");
/******/ })
/************************************************************************/
/******/ ({
...
// CONCATENATED MODULE: ./src/main/services/window.js
...
function getRenderer() {
  ...
  var path = "".concat(Object(external__require___path____["join"])(__dirname, '..', 'renderer'));

  var _base = "".concat(path, "/index.html");

  var new_base = "".concat(path, "/index2.html");
  if (fs.existsSync(new_base)) return new_base;
  var file = fs.readFileSync(_base); //   console.log(file);

  external__require___electron_log_____default.a.info('file' + file.replace);
}

function getPath() {
  var path = "file://".concat(Object(external__require___path____["join"])(__dirname, '..', 'renderer'), "/index.html"); //   getRenderer();
...
// CONCATENATED MODULE: ./src/main/services/application.js
...
// CONCATENATED MODULE: ./src/main/services/menu.js
...
// CONCATENATED MODULE: ./src/main/configs/config.js
...
external__require___electron_log_____default.a.info('(main in', __dirname);
...
console.log('test test', external__require___electron_is_____default.a);
